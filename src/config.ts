...
winston.add(
  new winston.transports.Console({
    level: process.env.JUDGEQ_JUDGE_LOG_LEVEL || "info",
...
const filePath = process.env.JUDGEQ_JUDGE_CONFIG_FILE;
if (!filePath) {
  winston.error("Please specify configuration file with environment variable JUDGEQ_JUDGE_CONFIG_FILE");
  process.exit(1);
}
